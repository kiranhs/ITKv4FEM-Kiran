...
public:
  ...
  /**
  * Type used to store node co-ordinates
  */
  typedef Node::ArrayType NodeArray;

  /**
  * Type used to element connectivity information
  */
  typedef Element::ArrayType ElementArray;

  /**
  * Type used to load data
  */
  typedef Load::ArrayType LoadArray;

  /**
  * Type used to store material data
  */
...
public:
  ...
  */
  bool InsertElement(Element::Pointer e, unsigned long index);
  ...
  */
  bool InsertNode(Node::Pointer e, unsigned long index);
 ...
 */
  ...
  */
  bool InsertMaterial(Material::Pointer e, unsigned long index);
...
*/
  ...
  * Insert material data at the specified location
  */
  bool InsertLoad(Load::Pointer ld, unsigned long index);

  /**
  * Get the element at the specified location
  */
  Element::Pointer GetElement(unsigned long index);

  /**
 * Get the node at the specified location
 */
  Node::Pointer GetNode(unsigned long index);

  /**
  * Get the material data at the specified location
  */
  Material::Pointer GetMaterial(unsigned long index);

  /**
 * Get the load data at the specified location
 */
  Load::Pointer GetLoad(unsigned long index);
 ...
 */
  ...
  /**
   * Get the number of loads specified in the mesh
   */
  unsigned long GetNumberOfLoads();
...
*/
  unsigned long GetNumberOfMaterials();
...
* Get the node array
*/
  Node::ArrayType& GetNodeArray();

  //  Node::ArrayType::iterator GetNodeArrayEnd();

  /**
* Get the element array
*/
  Element::ArrayType& GetElementArray();

  // Element::ArrayType::iterator GetElementArrayEnd();

  /**
* Get the material array
*/
  Material::ArrayType& GetMaterialArray();

//   Material::ArrayType::iterator GetMaterialArrayEnd();

  /**
* Get the load array
*/
  Load::ArrayType& GetLoadArray();

  //Load::ArrayType::iterator GetLoadArrayEnd();
  /**
* Remove material data at the specified location in the array
*/
  bool RemoveMaterial(int);

  /**
* Remove load data at the specified location in the array
*/
  bool RemoveLoad(int);
