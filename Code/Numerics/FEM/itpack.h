 ...
 * \param ier error flag (0 = success)
 */
extern doublereal eigvss_(integer *n,
                          doublereal *tri,
                          doublereal *start,
                          doublereal *zeta,
                          integer *itmax,
 ...
 * FIXME: add doc
 */
extern int parcon_(doublereal *dtnrm,
                   doublereal *c1,
                   doublereal *c2,
                   doublereal *c3,
                   doublereal *c4,
 ...
 * FIXME: add doc
 */
extern doublereal pbeta_(integer *nn,
                         integer *ia,
                         integer *ja,
                         doublereal *a,
                         doublereal *v,
