...
//        A, J1, J2, x0, y0, dx, dy, be, bn, ce, cn;
  ...
  //   x1 = this->m_node[0]->GetCoordinates()[0];   y1 =
  // this->m_node[0]->GetCoordinates()[1];
  //   x2 = this->m_node[1]->GetCoordinates()[0];   y2 =
  // this->m_node[1]->GetCoordinates()[1];
  //   x3 = this->m_node[2]->GetCoordinates()[0];   y3 =
  // this->m_node[2]->GetCoordinates()[1];
  //   x4 = this->m_node[3]->GetCoordinates()[0];   y4 =
  // this->m_node[3]->GetCoordinates()[1];
