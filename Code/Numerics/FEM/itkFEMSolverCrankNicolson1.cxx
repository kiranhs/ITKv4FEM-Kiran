...
void SolverCrankNicolson1::InitializeForSolution()
{
 ...
 */
void SolverCrankNicolson1::AssembleKandM()
{
 ...
 */
void SolverCrankNicolson1::AssembleFforTimeStep(int dim)
{
  /* if no DOFs exist in a system, we have nothing to do */
  if ( this->m_NGFN <= 0 ) { return; }
...
void SolverCrankNicolson1::RecomputeForceVector(unsigned int index)
{     //
 ...
 */
void SolverCrankNicolson1::Solve()
{
...
void SolverCrankNicolson1::FindBracketingTriplet(Float *a, Float *b, Float *c)
{
...
Element::Float SolverCrankNicolson1::BrentsMethod(Float tol, unsigned int MaxIters)
{
...
Element::Float SolverCrankNicolson1::GoldenSection(Float tol, unsigned int MaxIters)
{
  // We should now have a, b and c, as well as f(a), f(b), f(c),
  // where b gives the minimum energy position;
...
void SolverCrankNicolson1::SetEnergyToMin(Float xmin)
{
...
Element::Float SolverCrankNicolson1::GetDeformationEnergy(Float t)
{
...
Element::Float SolverCrankNicolson1::EvaluateResidual(Float t)
{
 ...
 */
void SolverCrankNicolson1::AddToDisplacements(Float optimum)
{
  /**
 ...
 */
void SolverCrankNicolson1::PrintMinMaxOfSolution()
{
  /**
   * Copy the resulting displacements from
   * solution vector back to node objects.
 ...
 * stored in node objects). This is standard post processing of the solution.
 */
void SolverCrankNicolson1::AverageLastTwoDisplacements(Float t)
{
  Float maxs = 0.0;
...
void SolverCrankNicolson1::ZeroVector(int which)
{
  for ( unsigned int i = 0; i < this->m_NGFN; i++ )
    {
...
void SolverCrankNicolson1::PrintDisplacements()
{
...
void SolverCrankNicolson1::PrintForce()
{
