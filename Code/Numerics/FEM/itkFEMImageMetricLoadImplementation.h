...
public:
  ...
  static void ImplementImageMetricLoad(TElementClassConstPointer element,
...
private:
  ...
  static void Implementation(typename Element::ConstPointer element,
                             ...
                             typename Element::VectorType & Fe)
  {
    ...
    typename Solution::ConstPointer S = l0->GetSolution(); // has current
                                                           // solution state
