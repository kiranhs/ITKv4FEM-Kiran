/*=========================================================================
  ...
  Module:    itkFEMLoadGravConstTestUser.cxx
  Language:  C++
  Date: $Date$
  Version:   $Revision$
...
int itkFEMLoadGravConstTest(int argc, char *argv[])
{
	...
	SpatialReader->SetFileName("C:/Research/ITKGit/ITK/Testing/Data/Input/FEM/LoadGravConstTest.meta");
	...
	SpatialWriter->SetFileName("C:/Research/ITKGit/ITK/Testing/Data/Input/FEM/LoadGravConstWrite.meta");
