/*=========================================================================
  ...
  Module:    itkFEMElement2DC0LinearQuadrilateralMembraneTest.cxx
  Language:  C++
  Date: $Date$
  Version:   $Revision$
...
int itkFEMElement2DC0LinearQuadrilateralMembraneTest(int argc, char *argv[])
{
	...
	SpatialReader->SetFileName("C:/Research/ITKGit/ITK/Testing/Data/Input/FEM/2DC0LinearQuadrilateralMembraneTest.meta");
	...
	SpatialWriter->SetFileName("C:/Research/ITKGit/ITK/Testing/Data/Input/FEM/2DC0LinearQuadrilateralMembraneTestWrite.meta");
