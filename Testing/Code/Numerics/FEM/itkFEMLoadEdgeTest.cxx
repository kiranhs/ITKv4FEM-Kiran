/*=========================================================================
  ...
  Module:    itkFEMLoadEdgeTestUser.cxx
  Language:  C++
  Date: $Date$
  Version:   $Revision$
...
int itkFEMLoadEdgeTest(int argc, char *argv[])
{
	...
	SpatialReader->SetFileName("C:/Research/ITKGit/ITK/Testing/Data/Input/FEM/LoadEdgeTest.meta");
	...
	SpatialWriter->SetFileName("C:/Research/ITKGit/ITK/Testing/Data/Input/FEM/LoadEdgeTestWrite.meta");
